...
class ConvNextSmall(pl.LightningModule):
    def __init__(self, config):
        ...
        self.fc = nn.Linear(1000, self.config["num_classes"])
    ...
    def configure_optimizers(self):
        return torch.optim.AdamW(self.fc.parameters(), self.config["lr"], weight_decay=1e-3)
